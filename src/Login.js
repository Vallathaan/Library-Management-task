...
function Login() {
  ...
  return (
    <>
        ...
        <div className="container-fluid h-custom">
          <div className="row d-flex justify-content-center align-items-center h-100">
            <div className="col-md-9 col-lg-6 col-xl-5">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSaaw5lOqQgY8MyULeHH9b0GCRilfHdE1YSMlcxb9wSNQ&usqp=CAU&ec=48665699"
                className="img-fluid"
                alt="Sample image"
              />
            </div>
      ...
      {/* <Link to={"/portal/dashboard"}>Login as Librarian</Link>
      <br />
      <Link to={"/portal/books"}>Login as Reader</Link> */}
    </>
  );
}
